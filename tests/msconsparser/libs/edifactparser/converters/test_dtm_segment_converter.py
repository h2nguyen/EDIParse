...
from ediparse.libs.edifactparser.converters.dtm_segment_converter import DTMSegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentDTM
