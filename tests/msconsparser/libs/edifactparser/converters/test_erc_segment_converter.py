...
from ediparse.libs.edifactparser.converters.erc_segment_converter import ERCSegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentERC
