...
from ediparse.libs.edifactparser.converters import LOCSegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentLOC
...
class TestLOCSegmentHandler(unittest.TestCase):
    ...
    def test_handle_calls_convert_and_update_context(self):
        ...
        # Arrange
        line_number = 1
        element_components = ["LOC", "example", "data"]
