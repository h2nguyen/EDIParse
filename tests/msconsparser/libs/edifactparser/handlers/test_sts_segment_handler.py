...
from ediparse.libs.edifactparser.converters.sts_segment_converter import STSSegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentSTS
...
class TestSTSSegmentHandler(unittest.TestCase):
    ...
    def test_handle_calls_convert_and_update_context(self):
        ...
        # Arrange
        line_number = 1
        element_components = ["STS", "example", "data"]
