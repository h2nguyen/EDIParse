...
from ediparse.libs.edifactparser.converters import PIASegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentPIA
...
class TestPIASegmentHandler(unittest.TestCase):
    ...
    def test_handle_calls_convert_and_update_context(self):
        ...
        # Arrange
        line_number = 1
        element_components = ["PIA", "example", "data"]
