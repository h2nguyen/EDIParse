...
from ediparse.libs.edifactparser.converters import NADSegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentNAD


class TestNADSegmentHandler(unittest.TestCase):
    """Test case for the NADSegmentHandler class."""
