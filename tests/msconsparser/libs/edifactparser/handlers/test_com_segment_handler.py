...
from ediparse.libs.edifactparser.converters import COMSegmentConverter
from ediparse.libs.edifactparser.handlers import COMSegmentHandler
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentCOM
...
class TestCOMSegmentHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.handler = COMSegmentHandler(syntax_parser=self.syntax_parser)
    ...
    def test_init_creates_with_correct_converter(self):
        ...
        self.assertIsInstance(self.handler.converter, COMSegmentConverter)
