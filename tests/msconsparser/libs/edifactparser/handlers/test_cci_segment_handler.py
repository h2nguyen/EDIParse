...
from ediparse.libs.edifactparser.converters.cci_segment_converter import CCISegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentCCI
