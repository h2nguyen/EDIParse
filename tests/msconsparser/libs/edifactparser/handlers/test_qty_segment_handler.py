...
from ediparse.libs.edifactparser.converters import QTYSegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentQTY


class TestQTYSegmentHandler(unittest.TestCase):
    """Test case for the QTYSegmentHandler class."""

    def setUp(self):
        """Set up the test case."""
        self.syntax_parser = EdifactSyntaxHelper()
        self.handler = QTYSegmentHandler(syntax_parser=self.syntax_parser)
    ...
    def test_init_creates_with_correct_converter(self):
        ...
        self.assertIsInstance(self.handler.converter, QTYSegmentConverter)
    ...
    def test_handle_calls_convert_and_update_context(self):
        ...
        # Arrange
        line_number = 1
        element_components = ["QTY", "example", "data"]
