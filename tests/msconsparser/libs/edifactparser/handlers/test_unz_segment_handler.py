...
from ediparse.libs.edifactparser.converters import UNZSegmentConverter
...
from ediparse.libs.edifactparser.wrappers.segments import SegmentUNZ
...
class TestUNZSegmentHandler(unittest.TestCase):
    ...
    def test_init_creates_with_correct_converter(self):
        ...
        self.assertIsInstance(self.handler.converter, UNZSegmentConverter)
    ...
    def test_handle_calls_convert_and_update_context(self):
        ...
        # Arrange
        line_number = 1
        element_components = ["UNZ", "example", "data"]
